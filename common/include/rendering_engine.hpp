...
// Rama analysis/writer: rendering_engine es SECUENCIAL (sin TBB)
// Solo PPMWriter usa paralelización en esta rama
...
// Rama analysis/writer: Rendering SECUENCIAL con bucles for simples
