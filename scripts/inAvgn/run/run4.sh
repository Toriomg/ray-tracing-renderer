...
echo "--- Iniciando ejecución 4 en $(hostname) ---"

# Rutas a los archivos de entrada y salida
CONFIG_FILE="res/config_scripts/config4example.txt"  
SCENE_FILE="res/scene_scripts/scene4example.txt"
OUTPUT_FILE_SOA="out4_SOA.ppm"
OUTPUT_FILE_AOS="out4_AOS.ppm"
