...
Estos, presentan unos resultado satisfactorios, que reducen significativamente el tiempo de ejecución con respecto al punto de partida inicial (ya teniendo en cuenta la implementación de BVH). Por ello, podemos concluir que nustra evaluación ha sido debidamente completada. 
