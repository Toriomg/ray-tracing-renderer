...
las siguientes herramientas, que se mantienen muy similares a las empleadas en la entrega anterior del proyecto: 
  ...
  cosa que ha incrementado notablemente su utilidad. Podemos dividir su uso en las siguientes áreas principales:
  ...
  En diferencia a la entrega anterior, y pese a seguir sin ser la herramienta más útil para la resolución de errores complejos, la actualización
  ha favorecido mucho su uso a lo largo de la realización del proyecto. Además, dada su velocidad de respuesta y agilidad resulta una herramienta 
  ...
  dar lugar a pequeños errores de fácil resolución, que Gemini 2.5 Pro es capaz de solventar de manera rápida y eficaz frente a otros LLM con 
  ...
  por tanto el número de bugs críticos también se ha visto reducido, el uso de Deepseek ha sido mucho más limitado, centrándose casi 
  exclusivamente en la resolución de problemas relacionados con la implementación en BVH que no fuimos capaces de resolver con Gemini.
]
